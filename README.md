...
[![Release](https://img.shields.io/badge/发行版-v134-blue)](https://github.com/YaChengMu/gkd_subscription_min/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-66-brightgreen)](./dist/README.md#应用规则)
[![全局规则组](https://img.shields.io/badge/全局规则组-3-blueviolet)](./dist/README.md#全局规则)
[![应用规则组](https://img.shields.io/badge/应用规则组-403-orange)](./dist/README.md#应用规则)
...
<!-- > 当前版本: v134
> 
> 当前订阅文件已适配 66 个应用，共有 403 应用规则组，3 全局规则组
> 
...
![img](https://contrib.rocks/image?repo=YaChengMu/gkd_subscription_min&max=200&_v=134)
