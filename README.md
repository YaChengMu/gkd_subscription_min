...
[![Release](https://img.shields.io/badge/发行版-v133-blue)](https://github.com/YaChengMu/gkd_subscription_min/releases/latest)
...
[![应用规则组](https://img.shields.io/badge/应用规则组-402-orange)](./dist/README.md#应用规则)
...
<!-- > 当前版本: v133
> 
> 当前订阅文件已适配 65 个应用，共有 402 应用规则组，3 全局规则组
> 
...
![img](https://contrib.rocks/image?repo=YaChengMu/gkd_subscription_min&max=200&_v=133)
